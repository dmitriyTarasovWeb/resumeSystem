...
namespace resumeSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (Input.AccountType is not ("Candidate" or "Recruiter"))
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var requiredAttributes = new RequiredUserAttributes
                    {
                        UserId = user.Id,
                    ...
                    _dbContext.RequiredUserAttributes.Add(requiredAttributes);
